...
public class Day2Test {
  ...
  public void testPart1() {
    AnnotatedIntCode annotatedIntCode = Assembler.compileAnnotated("2019/day2-part1.asm");
    IntCode vm = IntCode.fromResource(annotatedIntCode.getIntCode());

    System.out.println(annotatedIntCode);

    List<BigInteger> input = Util.readResource("2019/day2.in").stream()
  ...
  public void testPart2() {
    AnnotatedIntCode annotatedIntCode = Assembler.compileAnnotated("2019/day2-part2.asm");
    IntCode vm = IntCode.fromResource(annotatedIntCode.getIntCode());
